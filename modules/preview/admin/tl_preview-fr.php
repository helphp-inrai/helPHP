...
$tl_data = array(
    'fr' => array(
        'module_name' => 'Prévisualisation',
        'title' => 'Prévisualisation',
        'languages' => 'Langue',
        'refresh' => 'Rafraichit',
        'module' => 'Module',
        'picker' => 'Sélectionner un module',
        'smartphone' => 'Mobile',
        'tablet' => 'Tablette',
        'desktop' => 'PC',
        'picker_css' => 'Sélectionner une règle css',
        'site_public' => 'Version Publique',
        'admin' => ' - admin',
        'public' => ' - publique',
        'block' => 'Block $1',
        'document' => 'Document $1',
        'preview_new_rules' => 'Nouvelle règles',
